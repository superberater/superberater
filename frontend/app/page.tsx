      ...
      <section className="bg-gray-100 border-y border-gray-200 py-6 px-6">
        <div className="max-w-[800px] mx-auto text-center">
          <p className="text-xs text-gray-500 leading-relaxed">
            {locale === "de"
              ? "Open-Source-Projekt der superLab GmbH \u2014 Live-Demo zum GitHub-Repository. Kein kommerzielles Produkt, kein Bezahldienst. Ergebnisse werden von KI-Modellen Dritter generiert und k\u00F6nnen fehlerhaft sein. Keine Beratung, keine Gew\u00E4hr."
              : "Open-source project by superLab GmbH \u2014 live demo for the GitHub repository. Not a commercial product, not a paid service. Results are generated by third-party AI models and may be inaccurate. No consulting, no warranty."}
          </p>
        </div>
      </section>
        ...
        <div className="max-w-[1000px] mx-auto">
          <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-8">
            ...
            <div>
              ...
              <div className="text-gray-600 text-[10px] leading-relaxed max-w-[260px]">
                {locale === "de"
                  ? "Open-Source-Projekt der superLab GmbH. Live-Demo zum GitHub-Repository. Kein kommerzieller Dienst."
                  : "Open-source project by superLab GmbH. Live demo for the GitHub repository. Not a commercial service."}
              </div>
            </div>
            ...
            <div className="flex gap-12 text-xs">
              <div className="space-y-2">
                ...
                <a href="https://github.com/superlab-de/superberater" target="_blank" rel="noopener noreferrer" className="block text-gray-500 hover:text-gray-300 transition-colors">GitHub Repository</a>
                ...
                <span className="block text-gray-600">MIT License</span>
              </div>
              <div className="space-y-2">
